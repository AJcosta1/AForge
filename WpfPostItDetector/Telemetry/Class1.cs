...
namespace SDKSmartTrainnerAdaptor.Telemetry
{
    internal class Class1
    {
        /*
         * 
         * ScriptHookVDotNet Telemetry Server 
         * 
        Hi guys, since NGP 6 now has telemetry functions, is it possible to monitor values such as tire temperature and brake wear in real time using simhub or other apps? I've tried searching around and I haven't seen any options.Will it be possible for a custom plugin to be made for these in the future? Thanks!
