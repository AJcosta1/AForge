...
namespace IndoorCycling.Libs.BLE.ReceivedDataProcessing.Characteristics
{
    public partial class CharacteristicsRead
    {
        ...
        public static void TACX_FEC_WRITE_CHARACTERISTIC(Dictionary<string, byte[]> WorkingDataDictonaryByte_temp)
        {
            ...
            {
                //TYPE WRITE
                string characteristic = characteristics.TACX_FEC_WRITE_CHARACTERISTIC;
                characteristic = characteristic.ToUpper();
                if (ListaConfiguracaoDispositivos.characteristic == characteristic)
                {
                    ...
                    var x = WorkingDataGlobal.Current.SessonData;
                    var valueToWite = x.Slope;


                    /// <summary>
                    /// Write slope value in page 51
                    /// </summary>
                    string source = "_WriteTratedValue_1";

                    int slope = (int)((valueToWite+200) / 0.01);
                    byte[] result = BitConverter.GetBytes(slope);


                    //Command to send                
                    dataToWrite[0] = 0xA4; //Sync
                    dataToWrite[1] = 0x09; //Length
                    dataToWrite[2] = 0x4F; //Acknowledge message type
                    dataToWrite[3] = 0x05; //Channel

                    //Data
                    dataToWrite[4] = 0x33; //Page 51
                    dataToWrite[5] = 0xFF;
                    dataToWrite[6] = 0xFF;
                    dataToWrite[7] = 0xFF;
                    dataToWrite[8] = 0xFF;
                    dataToWrite[9] = result[0];
                    dataToWrite[10] = result[1];
                    dataToWrite[11] = 0xFF; //Total resistance
                    dataToWrite[12] = 0x00; //checksum
                    ...
                    /// <summary>
                    /// Write wheel diameter value in page 55
                    /// </summary>
                    /// 
                    source = "_WriteTratedValue_2";
                    ...
                    switch (message)
                    {
                        case (1):
                            ...
                            valueToWite = x.WheelPerimeter;

                            int WheelSetValue = (int)(valueToWite);
                                        ...
                                        //Data
                                        dataToWrite[4] = 0x37; //Page 55
                                        dataToWrite[5] = 0xFF; //rider weight LSB 0.01kg
                                        dataToWrite[6] = 0xFF; //rider weight MSB
                                        dataToWrite[7] = 0xFF;
                                        dataToWrite[8] = 0xFF;
                                        dataToWrite[9] = 0xFF;
                                        dataToWrite[10] = (byte)WheelSetValue; //wheel diameter   0.01m
                                        dataToWrite[11] = 0xFF;
                                        dataToWrite[12] = 0x00; //checksum
                        ...
                        case (2):
                            ...
                            //Data
                            dataToWrite[4] = 0x32; //Page 50
                            dataToWrite[5] = 0xFF; //rider weight LSB 0.01kg
                            dataToWrite[6] = 0xFF; //rider weight MSB
                            dataToWrite[7] = 0xFF;
                            dataToWrite[8] = 0xFF;
                            dataToWrite[9] = (byte)0;
                            dataToWrite[10] = (byte)0;
                            dataToWrite[11] = (byte)0;
                            dataToWrite[12] = 0x00; //checksum
