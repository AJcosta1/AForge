...
namespace IndoorCycling.Libs.BLE.ReceivedDataProcessing.Characteristics
{
    public partial class CharacteristicsRead
    {
        ...
        public static void indoor_bike_data(Dictionary<string,byte[]> WorkingDataDictonaryByte_temp)
        {
            ...
            {
                string characteristic = characteristics.IndoorBikeData;
                ...
                if (characteristic == parts[1])
                {
                    ...
                    if (connected(deviceID))
                    {
                        ...
                        if (characteristic == parts[1])
                        {
                            ...
                            //a velocidade vem em km/h
                      
                            value = (double)BitConverter.ToUInt16(ListaConfiguracaoDispositivos.Value, byteStart); //km/h
